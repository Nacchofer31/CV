...
\cvitem{ }{
\begin{itemize}
    \item \textbf{Programming Languages}: Java, Javascript, Kotlin, SQL, C\#, Swift, RESTful, JSON, XML and HTML.
    \item \textbf{Tools and Technologies}: Android SDK \& NDK, Andoid Studio, Docker, iOS SDK, Unit Testing, XCode, Visual Studio, Eclipse and Vim.
    \item \textbf{Operating Systems}: Windows, Arch Linux, Ubuntu, Debian, MAC OSX, iOS and Android.
    \item \textbf{VCS}: Java, Javascript, Kotlin, SQL, C\#, Swift
    \item \textbf{Methodologies}: Test Driven Development, Agile, SCRUM.
\end{itemize}
}
