...
\cvitem{ }{
\begin{itemize}%
    \item Accomplished Software Developer well-versed in creating native and hybrid applications for Android and iOS platforms with good knowledge of various programming languages and frameworks. 
    \item DevOps student interested to perform various DevOps practises, such as automating, supporting and to ensure CI/CD in product developing.
    \end{itemize}
}
\section{Work Experience} % =====================================

\cvitem{May 2020}{ \textbf{Mobile Developer at DEVELAPPS}, \textit{Valencia, Spain.}}
\cvitem{to PRESENT}{
    \begin{itemize}%
    \item Developing native Android apps with Kotlin, Model-View-ViewModel, Jetpack, Retrofit, AndroidX, Glide, Room...
    \item Creating cross-platform apps with Flutter, BLoC pattern, Clean Architecture, RxDart, Provider...
    \end{itemize}
}
...
\cvitem{2021}{ \textbf{Master's degree in DevOps} }
\cvitem{to PRESENT}{
\textit{La Universidad en Internet (UNIR), La Rioja (Remote), Spain }
}
...
\cvitem{2020}{ \textbf{Mobile Applications}, \textit{Erasmus+ program, \textit{University of Applied Sciences, Oulu, Finland} }
}
...
\cvitem{ }{
\begin{itemize}
    \item \textbf{Programming Languages}: Kotlin, Dart, Java, C\#, Javascript \& Typescript, SQL, Bash, JSON, XML, HTML, Markdown and \LaTeX.
    \item \textbf{Tools and Technologies}: Android SDK, Flutter, NodeJS, Angular, Cordova, Docker, Unit Testing, Restful, Andoid Studio, Visual Studio, XCode, Eclipse and Vim.
    \item \textbf{VCS}: Git.
    ...
    \item \textbf{Languages}: Spanish (\textit{Native}), English (\textit{Upper Intermediate - B2}), Catalan (\textit{Proficient}).
\end{itemize}
}
