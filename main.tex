...
\cvitem{to PRESENT}{
    ...
    \item Creating cross-platform apps with Flutter, BLoC pattern, Dio, RxDart, Provider...
    \end{itemize}
}
...
\cvitem{ }{
\begin{itemize}
    \item \textbf{Programming Languages}: Kotlin, Java, Javascript, NodeJS, SQL, C\#, Swift, RESTful, JSON, XML, markup languages including HTML, R Markdown and \LaTeX.
    \item \textbf{Tools and Technologies}: Android SDK \& NDK, Andoid Studio, Docker, Flutter, Cordova, Unit Testing, XCode, Visual Studio, Eclipse and Vim.
    \item \textbf{VCS}: Git.
    \item \textbf{Methodologies}: Test Driven Development and SCRUM.
    \item \textbf{Operating Systems}: Windows, Arch Linux, MacOS X, Ubuntu, iOS and Android.
