...
\title{Mobile \& Front-end Developer}
%%------------------------------------------------------------------------------
%% Content
%%------------------------------------------------------------------------------
\begin{document}
...
\cvitem{to PRESENT}{
    ...
    \item Creating cross-platform apps with Flutter, BLoC \& Cubit pattern, Dio, RxDart, Provider...
    \end{itemize}
}
...
\cvitem{to PRESENT}{
\textit{Universidad Politécnica de Valencia (UPV), Valencia, Spain }
}
