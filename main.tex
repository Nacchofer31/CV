...
\cvitem{ }{
\begin{itemize}%
    \item Accomplished Junior Software Developer well-versed in creating native and hybrid applications for Android and IOs platforms with good knowledge of various programming languages and frameworks. 
    \item IT student interested in innovative software solutions with great passion for writing clean and open code.
    \item Keen eye for detail.
    \item Technically certified in several computer operating software platforms.
    \end{itemize}
}
\section{Employment} % =====================================

\cvitem{Feb 2016}{ \textbf{Junior Android Developer}, \textit{Sportmaniacs, Valencia, Spain.}}
\cvitem{to Sep 2016}{
    \begin{itemize}%
    \item Part of a team that was tasked with developing TSportable, an Android mobile application to time races in places that are hard to get to whether there is coverage or not.
    \item Assisted in developing SportManiacs app, an Android mobile application to sign up races, genate tickets, browse race results, generate certificates...
    \item Worked with Model View Presenter, Retrofit, UnitTesting, ButterKnife, RxJava...
    \end{itemize}
}

\section{Education} % =====================================

\cvitem{2016}{ \textbf{Bachelor's Degree in Informatics Engineering} }
\cvitem{to PRESENT}{
\textit{Universidad Politécnica de Valencia (UPV), Spain }
}
\medskip
\cvitem{2014 to 2016}{ \textbf{Higher Technician in Multi-platform Applications Development}, \textit{Florida Universitaria }, Catarroja, Spain}

\cvitem{2015}{ \textbf{Introduction to Swift and iOS applications development with XCode}, \textit{Geekhubs}}
...
\hline Java & %%Lenguaje predominante, primer lenguaje con 4 años de experiencia. Recursividad, expresiones regulares, interfaces, uso de árboles, estructuras de datos y desarrollo de algoritmos de búsqueda. Uso de herramientas de diseño de aplicaciones de escritorio como WindowsBuilder y JavaFX. %% 
& High \\
 Android & 
 %2 años de experiencia. He participado en el desarrollo de aplicaciones nativas de ámbito académico y profesional. En cuanto ámbito profesional,  aplicaciones como Sportmaniacs y TSPortable disponibles en la PlayStore.  
 & High \\
 JS & 
 %Uso frecuente sobretodo en frameworks como Angular JS, Ionic 3 y Cordova. Actualmente aprendiendo React JS y mobile 
 & Medium \\
Swift & 
%Desarrollo de aplicaciones nativas de iOS de ámbito académico para productos iPhone y iPad. 
& Medium  \\
SQL & 
%Creación, consultas y operaciones de BBDD, uso de triggers, cursores  y predicados 
& Medium \\
Kotlin & 
%Conocimientos básicos del lenguaje. Sin experiencia en el desarrollo de proyectos, actualmente conociendo y estudiando el lenguaje 
& Low \\
\end{tabular}
}
\cvitem{}{
