...
\cvitem{2015}{ \textbf{Introduction to Swift and iOS applications development with XCode (60hrs)}, \textit{Geekhubs}
}
...
\begin{itemize}
    ...
    \item \textbf{Tools and Technologies}: Android SDK \& NDK, Andoid Studio, Docker, Cordova, Ionic, Unit Testing, XCode, Visual Studio, Eclipse and Vim.
    \item \textbf{VCS}: Git.
    \item \textbf{Methodologies}: Test Driven Development and SCRUM.
    \item \textbf{Operating Systems}: Windows, Arch Linux, Ubuntu, iOS and Android.
