...
\firstname{Ignacio}
\familyname{Ferrer}
\address{C/Maestro Serrano-4-1-1}{Benetússer - Valencia - Spain}
\mobile{608834425}
\email{ignaciofer31@gmail.com}
%\homepage{www.davidadler.me}
\extrainfo{\github{
\href{https://github.com/Nacchofer31}{github.com/Nacchofer31}
}}
\photo[64pt][0.4pt]{cvphoto.jpg}
...
\cvitem{ }{
\begin{itemize}%
    \item Junior Mobile Developer well-versed in creating native and hybrid applications for Android and IOs platforms with good knowledge of various programming languages and frameworks. 
    \item IT student interested in innovative software solutions with great passion for writing clean and open code.
    \end{itemize}
}
\section{Employment} % =====================================

\cvitem{De Feb 2016 }{ \textbf{Junior Android Developer}, \textit{Sportmaniacs, Valencia, Spain.}}
\cvitem{a Sep 2016}{
    \begin{itemize}%
    \item Desarrollo de la aplicación móvil Android TSPortable para el cronometraje de carreras de difícil acceso mediante un lector portable RFID.
    \item Desarrollo de la aplicación móvil SportManiacs, para la inscripción a carreras, generador justificantes, diplomas, venta de fotos...
    \end{itemize}
}

\section{Education} % =====================================

\cvitem{De 2016}{ \textbf{Ingeniería Informática}, \textit{Universidad Politécnica de Valencia (UPV) }}
\cvitem{hasta ahora}{
\begin{itemize}%
\item 1º Curso: \textit{recursividad, algoritmos de búsqueda y costes de los mismos con Java; operaciones básicas, uso de funciones y representación de las mismas mediante Mathematica; introducción a MIPS Assembly.}
\item 2º Curso: \textit{acceso a interfaces E/S y cache mediante MIPS Assembly; introducción al lenguaje C; shellscripting; creación de algoritmos básicos con Prolog y Haskell; interfaces, creación de algoritmos de búsqueda, árboles y estructuras de datos con Java; creación de interfaces y diseño de programas mediante la herramienta JavaFX; creación y recorrido de diferentes autómatas mediante Mathematica. }
\end{itemize}
}

\cvitem{2014--2016}{ \textbf{DAM, Grado Superior de Desarrollo de Aplicaciones Multiplataforma}, \textit{Florida Universitaria }, Catarroja.}
\cvitem{}{
\begin{itemize}%
\item 1º Curso: \textit{introducción a los lenguajes POO; conocimientos de BDD relacionales y mysql; conocimientos básicos de PHP; desarrollo de aplicaciones de escritorio y proyecto final de curso mediante la herramienta WindowsBuilder; lenguaje de marcas XML, CSS y HTML.}
\item 2º Curso: \textit{desarrollo de aplicaciones nativas y proyecto final de curso mediante lenguaje programación Android y como IDE Android Studio; desarrollo de aplicaciones multiplataforma mediante frameworks como Cordova y Phonegap; conocimientos básicos de Javascript; consultas y operaciones de base de datos mediante servicios RESTFul, conocimientos básicos de virtualización y uso de Odoo.}
\end{itemize}
}

\cvitem{2015}{ \textbf{Curso de Swift y desarrollo de aplicaciones iOS mediante XCode}, \textit{Geekhubs}, curso semi-presencial de 20h.}


\section{Skills} % =====================================
\cvitem{}{
{Idiomas: }{Español (nativo), Inglés (B2), Valenciano (B2).}
}
\cvitem{}{
...
\hline Java & Lenguaje predominante, primer lenguaje con 4 años de experiencia. Recursividad, expresiones regulares, interfaces, uso de árboles, estructuras de datos y desarrollo de algoritmos de búsqueda. Uso de herramientas de diseño de aplicaciones de escritorio como WindowsBuilder y JavaFX.  & Alta \\
 Android & 2 años de experiencia. He participado en el desarrollo de aplicaciones nativas de ámbito académico y profesional. En cuanto ámbito profesional,  aplicaciones como Sportmaniacs y TSPortable disponibles en la PlayStore.  & Alta \\
 JS & Uso frecuente sobretodo en frameworks como Angular JS, Ionic 3 y Cordova. Actualmente aprendiendo React JS y mobile & Media \\
Swift & Desarrollo de aplicaciones nativas de iOS de ámbito académico para productos iPhone y iPad. & Media  \\
SQL & Creación, consultas y operaciones de BBDD, uso de triggers, cursores  y predicados & Media \\
Kotlin & Conocimientos básicos del lenguaje. Sin experiencia en el desarrollo de proyectos, actualmente conociendo y estudiando el lenguaje & Baja \\
\end{tabular}
}
\cvitem{}{
{Otros: Lenguajes de marcas como HTLM5, XML y CSS; creación de documentos mediante {\LaTeX}; uso de Mathematica para la creación y representación de funciones; integración de los proyectos con git, usando plataformas como GitHub y BitBucket; metodología SCRUM y Kanban en el desarrollo de proyectos.  }
% \end{minipage}
}
